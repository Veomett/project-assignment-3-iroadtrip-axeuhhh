...
public class test {
	...
	//HashMaps for cost
	//HashMap<String,Node> cost;//dont neefd anymore
	
	//Set for fianlized 
	//Set<String> finailized;
	
	//Hash for neighbors/previous
...
//		test();
		...
		//System.out.println(findPath("Belgium","France"));
		//negativeOne();
		
		
		//System.out.println(dijkstra("Argentina", "Chile"));
